...
public class InventorySystem : MonoBehaviour{
    ...
    private void Start() {
        ...
        itemList = new ItemData[] {
            ...
            new ArmourData(new Metal[] { SmelteryController.oreDictionary[0], SmelteryController.oreDictionary[0], SmelteryController.oreDictionary[0]}, "Gloves", 1, "UI/arms", "A set of gloves that’ll keep scratches off your hands", Attribute.ArmourGloves),//6
            new ArmourData(new Metal[] { SmelteryController.oreDictionary[0], SmelteryController.oreDictionary[0], SmelteryController.oreDictionary[0]}, "Boots", 1, "UI/legs", "A set of boots - a little big to fill but you’ll do fine", Attribute.ArmourBoot),//7
